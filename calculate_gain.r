...
diffgroup_data <- as.data.table(read.csv('./data/data_for_gain_calculation/main_diffgroup_data.csv'))
agentwise_data <- read.csv('./data/data_for_gain_calculation/agentwise_data.csv')
callerwise_data <- read.csv('./data/data_for_gain_calculation/callerwise_data.csv')
...
write.csv(gain_by_diffgroup_all,'./data/data_for_gain_calculation/gain_by_diffgroup_all.csv',row.names = FALSE)
